...
public class MyChat implements ActionListener{
	...
	private void initialize() {
		...
		ipAddtextField.setToolTipText("Please enter IP Address in dotted decimal notation 0.0.0.0");
	...
	public static void receiveMethod() {
		...
		do {
			...
			Sounds receiveSound  = new Sounds("messageSound/234524__foolboymedia__notification-up-1.wav");
			...
			myChat.setInstance(array, sendInstance, StartChat, sourcePort, sourceAddress);
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Open New Chat":
			...
			if(!(array.isInArray(portNumber, otherHost))){ 
				...
				myChat.setInstance(array, sendInstance, StartChat, portNumber, otherHost);
